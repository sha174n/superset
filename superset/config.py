...
# Defaults to an empty list (all non-file:// URIs are blocked). To permit
# specific domains, add patterns such as:
#   DATASET_IMPORT_ALLOWED_DATA_URLS = [r"^https://.+\.example\.com/.*"]
